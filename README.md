...
## Compile AIHWKIT With cuda128

To install the aihwkit with sm_120 architecture (50 series GPU) follow:

### Create Env & Dependency
...
Install pytorch for cuda128

`pip3 install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu128`

### Compile CUDA & Build AIHWKIT

Clone aihwkit  
`git clone https://github.com/IBM/aihwkit.git`  
`cd aihwkit`

Install required dependencies (Remeber to remove `torch` and `torchvision` in `requirements.txt`)  
